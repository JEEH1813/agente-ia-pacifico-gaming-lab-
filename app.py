...
# 3. Inicialización de la base de datos de vectores (Cacheada para no recargar en cada interacción)
@st.cache_resource
def inicializar_base_conocimiento():
    ...
    # Carga de embeddings pesados (Railway soporta el uso de RAM necesario)
...
if resultado:
    ...
    # Algoritmo RAG puro con búsqueda por similitud vectorial
